package com.nijikokun.registerDM.payment;
...
public class Methods {
    ...
    private void _init() {
        this.addMethod("iConomy", new com.nijikokun.registerDM.payment.methods.iCo4());
        this.addMethod("iConomy", new com.nijikokun.registerDM.payment.methods.iCo5());
        this.addMethod("BOSEconomy", new com.nijikokun.registerDM.payment.methods.BOSE());
        this.addMethod("Essentials", new com.nijikokun.registerDM.payment.methods.EE17());
    }
